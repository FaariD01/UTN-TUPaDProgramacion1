...
print(f'La media es: {mean(num_random)}')
print(f'La mediana es: {median(num_random)}')
print(f'La moda es: {mode(num_random)}')
...
numVariable = int(input("Ingrese 1, 2 o 3 segun necesite "))
...
magnitudTerremoto = int(input("Ingrese la magnitud de un terremoto, rango 3 a 7. "))
